...
class ExportController extends Zend_Controller_Action
{
    ...
    public function yandexAction()
	{
		...
		$posts = $posts->GetAllToExportYandex();
		...
		foreach($posts as $post) {
			...
			$url->appendChild($xml->createTextNode($sitemap_url.'index/selectpost/id/'.$post->id));
			...
			$location->appendChild($xml->createTextNode($city->getName()));
